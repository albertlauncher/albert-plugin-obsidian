...
public:
    ...
    vector<Action> actions() const override
    {
        ...
        actions.emplace_back(
            ...
            [this] { openUrl(u"obsidian://open?vault=%1"_s.arg(QUrl::toPercentEncoding(identifier))); }
            );
        actions.emplace_back(
            u"search"_s, Plugin::tr("Search"),
            [this] { openUrl(u"obsidian://search?vault=%1"_s.arg(QUrl::toPercentEncoding(identifier))); }
            );
        return actions;
    }
        ...
        return {{u"open"_s,
                 ...
                 [this]{
                     openUrl(u"obsidian://open?vault=%1&file=%2"_s
                                 .arg(QUrl::toPercentEncoding(vault->identifier),
                ...
                {{
                    ...
                    [v, trimmed] {
                        openUrl(u"obsidian://new?vault=%1&file=%2"_s
                                  .arg(QUrl::toPercentEncoding(v->id()),
